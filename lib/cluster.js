    ...
    this.myriad.listen(function(){
        ...
        self.legiond.on("promoted", function(data){
            ...
            _.each(peers, function(host, id){
                self.core.loggers["containership.core"].log("debug", ["Found", host.mode, "node:", host.id].join(" "));
            });
...
Cluster.prototype.generate_id = function(fn){
    this.myriad.persistence.set(constants.myriad.CLUSTER_ID, crypto.generate_uuid(), fn);
}
